...
class App:
    def __init__(self, root):
        self.root = root
        self.root.title("Generator of metadata DEV (by multi_nono / nono)")
    ...
    def _create_widgets(self):
        ...
        refresh_button = tk.Button(command_control_frame, text="actualise the command", command=self._update_command_display)
